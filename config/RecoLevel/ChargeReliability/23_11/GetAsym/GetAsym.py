...
if __name__ == '__main__':
    ...
    dict_ParamSet["MuonRegion_MuonCharge"]=["BMuonChargeEvt","BJetWeightedCharge"]
    dict_ParamSet["MuonRegion_JetChargeRaw"]=["BMuonChargeEvt","bjet_charge"]

    dict_ParamSet["ElectronRegion_ElectronCharge"]=["BElectronChargeEvt","BJetWeightedCharge"]
    ...
    dict_ParamSet["UntaggedEvt_JetChargeWeighted"]=["UntaggedEvt","BJetWeightedCharge"]
    dict_ParamSet["UntaggedEvt_JetCharge"]=["UntaggedEvt","bjet_charge"]

    dict_ParamSet["AllFinal_JetCharge"]=["FinalSelection","bjet_charge"]

    cutlist=[0,0.3,0.5,0.6,0.7]
    for c in cutlist:
        print "[scorecut===",c,"]"
